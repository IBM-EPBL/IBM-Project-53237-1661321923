...
connection_string = "DATABASE=bludb;HOSTNAME=21fecfd8-47b7-4937-840d-d791d0218660.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31864;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=hsk39180;PWD=I8pd34bRkeA8f1m1",'',''.format(DATABASE_NAME, HOSTNAME, PORT_NUMBER, USERNAME, PASSWORD)
